    ...
    <>
      <div className='test-background'>
        ...
        <div className='flex md:flex-row'>
          <div className='hidden md:flex md:flex-row pt-2'><FastSurvey responseData={responseData} /></div>
            ...
            {testData && (
              <>
                <div className='scrollable-content md:max-h-[380px] max-h-[510px]'>
                  ...
                  <ChoiceThree data={testData} currentIndex={currentIndex} onResponseData={handleResponseData} />
                </div>
