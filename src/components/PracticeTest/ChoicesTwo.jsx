  ...
  return (
    <div className='flex flex-col'>
      <div className='bg-white md:w-[844px] w-[361px] mb-2'>
        <div className='mb-2 mt-2 ml-2'>Choose the correct answer 
        <div className=' md:ml-96 ml-[140px]'><Explanation/></div>
        </div>
        ...
        {choices.map((choice, index) => (
          <li key={index}>
            <button onClick={() => handleClick(choice.choiceId)}>
              <div className={`bg-white md:w-[844px] w-[361px] mb-2 hover:bg-gray-200 ${selected === choice.choiceId ? 'bg-indigo-200' : ''}`}>
