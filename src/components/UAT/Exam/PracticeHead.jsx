  ...
  return (
    <nav className="md:pl-7 pl-4 w-full flex py-3.5 md:justify-between items-center navbar pt-[30px] md:pt-[50px]">
      ...
      <div className='md:pl-[870px] ml-[138px]'>
        <p className='md:text-[18px] font-bold text-blue-100 md:text-lg md:font-bold font-bold text-[16px] cursor-pointer' onClick={handleRefreshClick}>Courses</p>
      </div>
      <a
        onClick={handleClick}
        className="md:text-[18px] text-blue-100 md:mr-[58px] ml-[50px] md:text-lg md:font-bold font-bold text-[16px] cursor-pointer"
      >
        Logout
      </a>
    </nav>
