...
import ForgetPasswordComponentsecond from './ForgetPasswordComponentsecond'
        ...
        <div className="absolute mt-[120] md:mt-[-30px] ml-1 md:ml-[600px]">
          <div className="mt-[90px] md:mt-[40px] md:ml-[30px] ml-[13px]">
            <div className="phone-container">
              <div className="mt-10 p-3 text-center text-2xl font-bold leading-9 tracking-tight create-account-style">Password Recovery</div>
              <div className="">
                ...
                <div className="otp-container">
                  {showComp && !isVerified ? (
                    ...
                    <ForgetPasswordFormsecond phoneNumber={phoneNumber}/>
                  )}
                </div>
