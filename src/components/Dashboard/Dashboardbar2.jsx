import {archaeological,dinosaur} from '../../assets'
    ...
    return (
      <div className=" ">
        <div className="md:w-[420px] w-[159px] md:h-[140px] h-[53px] bg-white md:rounded-[20px] rounded-md ">
          ...
          <div className="absolute md:ml-40 md:mt-12 ml-14 mt-3 text-black md:text-4xl font-normal font-['Inter']">History</div>
